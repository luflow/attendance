OC.L10N.register(
    ...
    "No connection" : "Нема мрежне везе",
    ...
    "Closed" : "Затворено",
    "Please try again later." : "Молимо вас да поново покушате касније.",
    "No activity yet" : "Још нема активности",
    "_+{count} more_::_+{count} more_" : ["+{count} још","+{count} још","+{count} још"],
    ...
    "Teams" : "Тимови",
    "Filter" : "Филтер",
    "Category: {category}" : "Категорија: {category}",
    "Manager" : "Менаџер",
    "Historic" : "Историјско",
