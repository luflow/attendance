		...
		<NcDialog
			...
			<div class="booking-confirm">
				<p class="booking-confirm__hint">
					{{ t('attendance', 'Closing notifies these people about their planning status.') }}
				</p>
				<div
...
const bookingDialogGroups = computed(() => [
	{
		key: 'booked',
		label: t('attendance', 'Planned in ({count})', { count: bookingGroups.value.booked.length }),
		names: bookingGroups.value.booked,
	},
	{
		key: 'declined',
		label: t('attendance', 'Not planned in ({count})', { count: bookingGroups.value.declined.length }),
