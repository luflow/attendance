...
// TRANSLATORS: Name of the smallest organization subscription plan.
t('attendance', 'Basic')
...
t('attendance', 'For your group')
t('attendance', 'Get a personal license for yourself, or save with one license for your whole group.')
t('attendance', 'Google Maps')
t('attendance', 'Groups (optional)')
t('attendance', 'Groups (required)')
t('attendance', 'Hold a tag to the back of your phone …')
t('attendance', 'Hold your phone near the check-in tag')
t('attendance', 'Hold your phone near the tag to write it')
...
// formatted in the store's own currency. Keep the placeholder intact.
t('attendance', 'That is {price} a month.')
...
// without the global permission to see responses. "where" means "for those
// appointments where", not a place inside the bar.
...
// TRANSLATORS: Nudge shown to appointment managers when several people on the
// same server pay for individual personal licenses; %n is how many.
n('attendance', '%n person on this server pays for a personal license — one organization license covers everyone and costs less', '%n people on this server pay for personal licenses — one organization license covers everyone and costs less', 1)
